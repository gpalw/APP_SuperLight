...
public class ColorPickerDialog extends Dialog{
   //对话框大小
    ...
    //内部圆心的半径
    private  final int CENTER_RADIUS=(COLOR_DIALOG_WIDTH+COLOR_DIALOG_HEIGHT)/20;
    ...
    private class ColorPickerView extends View{
        ...
        protected void onDraw(Canvas canvas) {
            float r = CENTER_X - mPaint.getStrokeMiter()*0.5f-20;
        ...
        //从颜色带中取出的值
        private int interpCorlor(int colors[],float unit){
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            switch (event.getAction()){
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (unit<0)unit+=1;
                    mCenterPaint.setColor(interpCorlor(mColors,unit));
                    invalidate();
                    break;
